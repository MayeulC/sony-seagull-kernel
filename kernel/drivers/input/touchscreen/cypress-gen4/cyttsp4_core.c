		...
		struct device_attribute *attr, char *buf)
{
	...
	cydata = cd->sysinfo.si_ptrs.cydata;
        ...
        return snprintf(buf, CY_MAX_PRBUF_SIZE,
                ...
                cydata->revctrl[7],
                "TrueTouch Config Version", cydata->cyito_verh, cydata->cyito_verl,
...
static struct device_attribute attributes[] = {
	...
	__ATTR( set_mode, S_IWUSR, NULL, cyttsp4_set_mode_store),
	__ATTR( get_bootloader_state, S_IRUGO, cyttsp4_bootloader_mode_show, NULL ),
	__ATTR( glove, S_IRUSR | S_IWUSR, cyttsp4_signal_disparity_show, cyttsp4_signal_disparity_store ),
