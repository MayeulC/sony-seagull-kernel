 ...
 * Copyright (C) 2012-2013 Sony Mobile Communcations AB
 *
...
void Document::processHttpEquiv(const String& equiv, const String& content)
{
    ...
    if (equalIgnoringCase(equiv, "default-style")) {
        ...
        if (isWMLDocument()) {
            ...
            static_cast<WMLDocument*>(this)->setCookie(content, ec);
        }
#endif
...
PassRefPtr<Event> Document::createEvent(const String& eventType, ExceptionCode& ec)
{
    ...
    if (eventType == "Event" || eventType == "Events" || eventType == "HTMLEvents")
        ...
        event = PopStateEvent::create(SerializedScriptValue::nullValue());
