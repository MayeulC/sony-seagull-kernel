...
void WMLTaskElement::storeVariableState(WMLPageState* pageState)
{
    ...
    // when store variable state, restore variable map will clean previous variable.
    // it means storeVariables(variables) will clean previous variable,
    // but storeVariable(name, value) will append the name/value pair.
