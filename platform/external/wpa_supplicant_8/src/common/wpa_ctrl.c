...
#include <android/log.h> //CONN-CD-ReturnSocketTimeout-00+
#endif /* ANDROID */
...
retry_send:
	...
	for (;;) {
		...
		if (res < 0)
			return res;
		//CONN-CD-ReturnSocketTimeout-00+[
		else if (res == 0)
		{
			/* Timeout, print message to monitor. */
			__android_log_print( ANDROID_LOG_ERROR, "wpa_ctrl", 
				"wpa_ctrl_request - select() timeout.\n");
			return -2;
		}
		//CONN-CD-ReturnSocketTimeout-00+]
