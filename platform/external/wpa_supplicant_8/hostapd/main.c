...
#include <cutils/properties.h> //CONN-EC-WIFI-LOG-01+
...
int main(int argc, char *argv[])
{
    ...
    char hostapd_dbg[PROPERTY_VALUE_MAX] = {'\0'}; //CONN-EC-WIFI-LOG-01+
    ...
    //CONN-EC-WIFI-LOG-01+[
    property_get("persist.hostapd.dbg", hostapd_dbg, "false");
    if (strcmp(hostapd_dbg, "true") == 0) {
        wpa_debug_level = MSG_EXCESSIVE;
        wpa_printf(MSG_INFO, "persist.hostapd.dbg true debug level MSG_EXCESSIVE");
    } else {
        wpa_debug_level = MSG_INFO;
        wpa_printf(MSG_INFO, "persist.hostapd.dbg false debug level MSG_INFO");
    }
    //CONN-EC-WIFI-LOG-01+]
