...
INCLUDES += external/wpa_supplicant_8/wpa_supplicant/wapi_drop/inc
INCLUDES += external/wpa_supplicant_8
ifdef CONFIG_FIPS
...
OBJS += src/eap_peer/eap_proxy_dummy.c
CONFIG_IEEE8021X_EAPOL=y
endif
...
OBJS += wapi_drop/src/wlan_wapi_sms4c.c \
	wapi_drop/src/wlan_wapi_wpi_pcrypt.c \
	wapi_drop/src/wlan_wapi_ecc.c \
	wapi_drop/src/wlan_wapi_pack.c \
	wapi_drop/src/wlan_wapi_unpack.c \
	wapi_drop/src/wlan_wapi_x509.c \
	wapi_drop/src/wlan_wapi_wapicert.c \
	wapi_drop/src/wlan_wapi_waiprocess.c\
OBJS += os_adaptor.c
endif
