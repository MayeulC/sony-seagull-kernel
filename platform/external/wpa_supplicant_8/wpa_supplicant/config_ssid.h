...
#define MAX_WEP_KEY_LEN 16
	...
	/**
	 * forbidden_deletion - Whether this network is read-only
	 *
	 * 0 = this network can be modified/removed (default).
	 * 1 = this network block is read-only (no modification
	 * or removal can be done).
	 */
	int forbidden_deletion;

	/**
	 * no_auto_connect - Whether this network will auto connect or not
	 *
	 * 0 = this network will auto connect
	 * 1 = this network will not auto connect
	 */
	int no_auto_connect;

	/**
	 * disabled_for_auto_connect - Whether manual network was temporarily disabled
	 *
	 * This flag is used to indicate whether the manual network is selected
	 * for connection or not.
	 */
	int disabled_for_auto_connect;
...
#define P2P_MAX_STORED_CLIENTS 100
	...
	/**
	 * cred_id - Id for the credential this network block creates
	 *
	 * If this network block is created from the credential by interworking,
	 * this contains valid id otherwise -1
	 */
	int cred_id;
};
